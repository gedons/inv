...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('admin.invest')}}">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="{{route('admin.invest')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"> Add New </a>
                    </div>
                                                      ...
                                                      <tbody>
                                                        @foreach($investments as $investment) 
                                                          <tr>
                                                              ...
                                                              <td>
                                                                 <a href="{{route('invest.edit', $investment->id)}}" class="btn btn-light" style="color:rgb(129, 118, 230)">Edit</a>
