...
Route::post('/home/message/send', [App\Http\Controllers\MessageController::class, 'sent'])->name('front.send');
Route::post('/home/message/delete/{id}', [App\Http\Controllers\MessageController::class, 'delete'])->name('front.delete');
